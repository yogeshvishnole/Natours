...
var showAlert = function showAlert(typ, msg) {
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(typ, "\">").concat(msg, "</div>");
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieW9nZXNoMjAwMCIsImEiOiJjazF2dXo2OWMxYWdpM2NrYXVuMTF6N2RwIn0.bsML-mKk91TfBl0eBv4xJg';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //Extend map bound to add current location
...
var stripe = Stripe('pk_test_lV6WfC1yyOwHrJ9zqC2Uc7Ux00nOsALMKG');
...
console.log(document.querySelector('.nav__el--logout')); // Delegation
